                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="about-slider owl-carousel owl-theme dots-simple">
                                <div class="about-slider-item">
                                    <img class="owl-lazy"
                                        data-src="{{ asset('shop/assets/images/demoes/demo3/about/img-1.jpg') }}"
                                        src="{{ asset('shop/assets/images/lazy.png') }}" alt="About image description">
                                </div>
                                <div class="about-slider-item">
                                    <img class="owl-lazy"
                                        data-src="{{ asset('shop/assets/images/demoes/demo3/about/img-2.jpg') }}"
                                        src="{{ asset('shop/assets/images/lazy.png') }}" alt="About image description">
                                </div>
                                <div class="about-slider-item">
                                    <img class="owl-lazy"
                                        data-src="{{ asset('shop/assets/images/demoes/demo3/about/img-3.jpg') }}"
                                        src="{{ asset('shop/assets/images/lazy.png') }}" alt="About image description">
                                </div>
